...
export default function SEOCheckerTool() {
    ...
    const runAnalysis = async (e: React.FormEvent) => {
        ...
        const performHeuristicAnalysis = (url: string) => {
            ...
            return {
                ...
                timestamp: new Date().toLocaleString() + " (Saved Report)",
                sections: [
                    {
                        id: "meta",
                        title: "Meta & Content",
        ...
        try {
            addLog("SCANNING WEBSITE PERFORMANCE...");
            setProgress(10);
            ...
            if (!response.ok) {
                ...
                if (response.status === 429 || errData.error?.includes("Quota")) {
                    addLog("REMOTE QUOTA REACHED. SWITCHING TO LOCAL SEO SCAN...");
                    ...
                    addLog("RETRIEVING PERFORMANCE DATA...");
                    setProgress(85);
            ...
            addLog("ANALYZING SEO DATA...");
            const data = await response.json();
            const lh = data.lighthouseResult;
            
            if (!lh) throw new Error("NO DATA RECEIVED: PLEASE TRY AGAIN");

            addLog("EVALUATING PAGE LOAD SPEED...");
            setProgress(60);
            ...
            addLog("CHECKING SEO METRIC LEVELS...");
            setProgress(85);
            ...
            addLog("SUCCESS: AUDIT COMPLETED");
            setProgress(100);
            ...
            console.error(error);
            addLog("SWITCHING TO LOCAL AUDIT...");
            await new Promise(r => setTimeout(r, 1000));
    ...
    const handleExport = () => {
        if (!report) return;
        const data = `TELLORA SEO REPORT\nURL: ${report.url}\nScore: ${report.overallScore}%\nDate: ${report.timestamp}\n\nGenerated by Tellora Media - Digital Marketing Agency.`;
                    ...
                    <div className="brutalist-card p-12 bg-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-lg font-black uppercase opacity-60 mb-10 tracking-widest leading-tight">
                                Connect your domain and receive a comprehensive performance breakdown in seconds.
                            </p>
                            ...
                            <form onSubmit={runAnalysis} className="flex flex-col md:flex-row gap-6">
                                ...
                                >
                                    RUN AUDIT <ArrowRight size={24} className="group-hover:translate-x-3 transition-transform" />
                                </button>
                            </form>
                        </div>
                    </div>
                        ...
                        <div className="brutalist-card p-12 bg-primary text-black overflow-hidden shadow-[20px_20px_0px_#000] min-h-[400px] flex flex-col justify-between">
                            <div className="flex justify-between items-start mb-12">
                                <div className="flex items-center gap-4">
                                    ...
                                    <h3 className="text-2xl font-black uppercase tracking-widest text-black">Analyzing: SEO Audit</h3>
                                </div>
                            ...
                            <div className="lg:col-span-2 brutalist-card p-12 bg-white relative overflow-hidden flex flex-col justify-center">
                                ...
                                <div className="relative z-10">
                                    <div className="inline-flex items-center gap-4 px-6 py-2 bg-black text-white brutalist-border rotate-[-1deg] mb-8">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-[0.4em]">Audit Complete • Report Generated</span>
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="mt-12 p-8 bg-accent/10 brutalist-border border-accent/20">
                                    <h4 className="font-black uppercase text-xs mb-4 tracking-widest text-accent flex items-center gap-2">
                                        <Eye size={14} /> Audit Insights
                                    </h4>
                                    <p className="text-[12px] font-black uppercase leading-tight opacity-70">
                                        This site is performing in the top 15% of its category. Optimize image assets to achieve higher speeds.
                                    </p>
                                </div>
                                ...
                                <div className="bg-black text-white p-12 brutalist-border shadow-[12px_12px_0px_#F3E84A] relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                                        <div className="max-w-xl text-center md:text-left">
                                            ...
                                            <p className="text-sm font-black uppercase tracking-[0.2em] opacity-60">Our marketing team can implement these fixes to help you scale.</p>
                                        </div>
