            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
                    ...
                    <Link href="/services" className="lg:col-span-2 relative group h-full block">
                        <AdvancedCard className="h-full bg-white/5 backdrop-blur-md !border-[2px] !border-primary/30 text-white min-h-[250px] md:min-h-[400px]">
                            <div className="p-4 md:p-14 h-full flex flex-col relative z-10 w-full">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <h3 className="text-xl md:text-5xl font-heading font-black uppercase mb-2 md:mb-4 tracking-tighter leading-none">
                    ...
                    <Link href="/services" className="relative group h-full block">
                        <AdvancedCard className="h-full bg-primary !border-none text-white min-h-[250px] md:min-h-[400px] shadow-[8px_8px_0px_#000]">
                            <div className="p-4 md:p-14 h-full flex flex-col items-start justify-end relative z-10 overflow-hidden w-full">
                                ...
                                <h3 className="text-xl md:text-5xl font-heading font-black uppercase tracking-tighter text-black leading-none">
                                    Autonomous Scale
                                </h3>
                    ...
                    <Link href="/services" className="relative group h-full block">
                        <AdvancedCard className="h-full bg-[#111] !border-[2px] !border-white/10 text-white min-h-[250px] md:min-h-[400px]">
                            <div className="p-4 md:p-14 h-full flex flex-col justify-end relative z-10 w-full group-hover:bg-[#1a1a1a] transition-colors duration-500 rounded-[2rem] md:rounded-[3rem]">
                                ...
                                <h3 className="text-xl md:text-4xl font-heading font-black uppercase tracking-tighter leading-none">
                    ...
                    <Link href="/services" className="lg:col-span-2 relative group h-full block">
                        <AdvancedCard className="h-full bg-accent !border-none text-black min-h-[250px] md:min-h-[400px] overflow-hidden shadow-[8px_8px_0px_#000]">
                            <div className="p-4 md:p-14 h-full flex flex-col lg:flex-row items-start lg:items-end justify-between relative z-10 gap-4 md:gap-8 w-full">
                                <div className="max-w-md mt-auto">
                                    ...
                                    <h3 className="text-xl md:text-5xl font-heading font-black uppercase tracking-tighter mb-2 md:mb-4 leading-none">
                                        Omnichannel Sync
                                    </h3>
