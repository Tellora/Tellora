                        ...
                        <div className="container mx-auto px-6">
                            <div className="mb-32">
                                <div className="inline-flex items-center gap-4 mb-6 px-6 py-2 bg-black text-white brutalist-border rounded-full -rotate-1 shadow-[4px_4px_0px_#FFD700]">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.4em]">{group.category}</span>
                                </div>
                                <h2 className="text-6xl md:text-[10rem] font-heading font-black text-black leading-none tracking-tighter uppercase">{group.category.split(' & ')[0]} <br /> <span className="text-primary italic">& {group.category.split(' & ')[1]}</span></h2>
                            </div>
